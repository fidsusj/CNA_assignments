...
\begin{enumerate}
	...
	Yes, the graph is bipartite. It can be divided into the two disjoint sets $U = {A, D}$ and $V = {B, C, E}$. The nodes connect these two sets, but never connect two nodes in one set.
